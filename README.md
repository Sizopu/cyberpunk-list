...
**Аватар персонажа:**
- Кликните на область с отпечатком пальца (над датой `[03-06-22]`)
- Откроется диалоговое окно
- Вставьте прямую ссылку на изображение с Imgur (должна заканчиваться на `.png`, `.jpg`, `.gif` или `.webp`)
- Пример: `https://i.imgur.com/YourImage.png`
...
- Содержит пример персонажа "Rockerboy" с полными данными
- Включает 2 примеров мобов (Gang Thug и Corporate Guard)
- Содержит пример аватара (замените ссылку на свою)
- Используйте для тестирования импорта или как шаблон

**Как использовать:**
1. Нажмите **📂 Load**
2. Выберите файл `test-character.json`
